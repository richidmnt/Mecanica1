    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('danios_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ordenes', to='Gestion.danio')),
                ('inspeccion_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ordenes', to='Gestion.inspeccion')),
                ('usuario_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ordenes', to='Gestion.usuario')),
            ],
        ),
        migrations.AddField(
            model_name='danio',
            name='orden',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Gestion.orden'),
        ),
        migrations.CreateModel(
            name='OrdenRepuesto',
            fields=[
